...
1. [https://developer.apple.com](https://developer.apple.com) で Apple Developer Program 登録 ($99/年)
2. [Identifiers](https://developer.apple.com/account/resources/identifiers) で **Media IDs → Music** を作成
3. [Keys](https://developer.apple.com/account/resources/authkeys) で **MusicKit** を有効にした Key を作成、`.p8` をダウンロード
4. Team ID (右上) と Key ID をメモ
5. `APPLE_TEAM_ID`, `APPLE_KEY_ID`, `APPLE_PRIVATE_KEY` を環境変数へ
